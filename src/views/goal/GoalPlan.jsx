...
import { computeGoalPlan, formatGoalText, simulateGoal, analyzeRoadmap, interpretPlan } from "../../engines/goalplan";
...
import { TEMPLATE_LIST, templateFor, newPhase, derivedPhases, activePhase as activePhaseV3, alignmentFor, planEndDate, addPhaseOp, deletePhaseOp, duplicatePhaseOp, movePhaseOp, updatePhaseOp } from "../../engines/phaseV3";
import { computePhysiologyState } from "../../engines/physiology";
import { computeRecoveryCapacity } from "../../engines/recoveryCapacity";
import { computePhaseResult, summarizeDecisions, evaluateDecisions } from "../../engines/strategy";
...
import { V3MusclePrioCard } from "../../views/WorkoutScreen";
...
export function GoalPlanV3({ data, goals, onSaveGoals, addEntry, deleteEntry }) {
